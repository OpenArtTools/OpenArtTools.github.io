...
export const exhibitionCustodyEs: TemplateDoc = {
  ...
  steps: [
    ...
    },
    {
      ...
      blurb:
        "De qué obra y evento se trata, cuándo se exhibe y dónde se firma. Al final, solo si este texto es un anexo a otro acuerdo.",
    },
    {
      id: "features",
      title: "Características",
      blurb: "Cómo es la instalación: tipo de obra, sistemas técnicos, riesgos y condiciones de acceso al público. Activar solo lo que aplique.",
    },
    {
      id: "custody",
      title: "Montaje y custodia",
      blurb:
        "Quién monta, si hay retirada diaria de piezas y si hay que proteger frente al clima.",
    },
    {
      id: "insurance",
      title: "Seguros y valor",
      blurb:
        "Primero, qué seguros aporta el solicitante. Después, el valor declarado de la obra (sistema y, si hay, piezas individuales).",
    },
    {
      id: "options",
      title: "Cláusulas opcionales",
      blurb:
        "Extras del acuerdo, en el mismo orden en que aparecerán en el documento. Abrir solo los bloques que hagan falta.",
    },
  ],
  fields: [
    {
    ...
    },
    {
      ...
      step: "features",
      group: "4. Público, vigilancia y señalización",
    },
    {
      id: "feat_watch",
    ...
    },
    {
      ...
      step: "insurance",
      group: "1. Qué seguros aporta el solicitante",
    },
    {
      id: "has_nail",
    ...
    },
    {
      ...
      step: "insurance",
      group: "2. Valor económico de la obra",
      showIfAny: [
        "features.mechanical",
        "features.electrical",
    ...
    },
    {
      ...
      step: "options",
      group: "Acta de entrega y devolución",
    },
    {
      id: "opt_policy_certs",
    ...
    },
    {
      ...
      step: "options",
      group: "Peritaje si hay pérdida artística",
    },
    {
      id: "opt_transport",
    ...
    },
    {
      ...
      step: "options",
      group: "Cambios de ubicación o instalación",
    },
    {
    ...
    },
    {
      ...
      step: "options",
      group: "Fotos, vídeo y reproducción",
    },
    {
      id: "image_scope",
    ...
    },
    {
      ...
      step: "options",
      group: "Si también se contempla vender la obra",
    },
    {
      id: "sale_price",
    ...
    },
    {
      ...
      step: "options",
      group: "Cancelación o retirada anticipada",
    },
    {
    ...
    },
    {
      ...
      step: "options",
      group: "Emails para avisos formales",
    },
    {
...
export { enrichDerivedValues } from "./exhibition-custody-enrich";
