...
export const exhibitionCustodyEs: TemplateDoc = {
  ...
  steps: [
    ...
    },
    {
      ...
      blurb:
        "Bloques en el orden habitual de un acuerdo de exhibición y custodia. Incluir solo lo necesario; lo desactivado no aparece en el documento.",
    },
  ],
  fields: [
    // —— Autoría ——
    ...
    // —— Opcionales I: entrega / espacio ——
    {
      ...
      step: "options",
      group: "I. Entrega, espacio e inventario",
    },
    {
    ...
    // —— Opcionales II: seguros ——
    {
      ...
      step: "options",
      group: "II. Seguros complementarios",
    },
    {
      id: "opt_franchise",
    ...
    // —— Opcionales III: logística ——
    {
      ...
      step: "options",
      group: "III. Logística y economía",
    },
    {
    ...
    // —— Opcionales IV: operación ——
    {
      ...
      step: "options",
      group: "IV. Operación durante la exhibición",
    },
    {
    ...
    // —— Opcionales V: derechos ——
    {
      ...
      step: "options",
      group: "V. Derechos de imagen, PI y venta",
    },
    {
      id: "image_scope",
    ...
    // —— Opcionales VI: extinción y cierre ——
    {
      id: "opt_cancellation",
      ...
      step: "options",
      group: "VI. Extinción, avisos y marco legal",
    },
    {
